 ...
 * @author Ebula Shisso
 */
public class Available_Rooms extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public Available_Rooms(Vector data, Vector cols) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Available_Rooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new Available_Rooms().setVisible(true);
            }
        });
    }
